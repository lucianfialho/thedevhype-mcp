...
export default async function DashboardPage() {
  ...
  return (
    <main className="mx-auto max-w-3xl p-6">
      ...
      <Link
        href="/dashboard/eloa"
        className="mb-8 flex items-center gap-4 rounded-lg border border-zinc-200 p-5 transition-colors hover:border-zinc-300 hover:shadow-sm dark:border-zinc-800 dark:hover:border-zinc-700"
      >
        <img
          src="/eloa.png"
          alt="Eloa"
